...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Codealpine.UsersApi();
  });
    ...
    describe('UsersApi', function() {
      describe('userControllerUpdate', function() {
        it('should call userControllerUpdate successfully', function(done) {
          // TODO: uncomment, update parameter values for userControllerUpdate call and complete the assertions
          /*

          instance.userControllerUpdate(body, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
