...
var UsersApiRequestFactory = (function (_super) {
    ...
    UsersApiRequestFactory.prototype.userControllerUpdate = function (id, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var config, localVarPath, requestContext, contentType, serializedBody;
            return __generator(this, function (_a) {
                config = options || this.configuration;
                if (id === null || id === undefined) {
                    throw new baseapi_1.RequiredError('Required parameter id was null or undefined when calling userControllerUpdate.');
                }
                if (body === null || body === undefined) {
                    throw new baseapi_1.RequiredError('Required parameter body was null or undefined when calling userControllerUpdate.');
                }
                localVarPath = '/api/user/{id}'
...
var UsersApiResponseProcessor = (function () {
    ...
    UsersApiResponseProcessor.prototype.userControllerUpdate = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 1:
                        body_1 = _b.apply(_a, [_d.apply(_c, [_j.sent(), contentType]), "string", ""]);
                        return [2, body_1];
                    case 2:
                        ...
                        return [4, response.body.text()];
                    case 3:
                        body_2 = _f.apply(_e, [_h.apply(_g, [_j.sent(), contentType]), "string", ""]);
                        return [2, body_2];
                    case 4:
                        body = response.body || "";
