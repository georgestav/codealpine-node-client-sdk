...
* @version 1.0
*/
export default class ClimbingStatsApi {
    ...
    */
     ...
     * @callback module:api/ClimbingStatsApi~climbingStatsControllerGetUserProfileCallback
     ...
     * @callback module:api/ClimbingStatsApi~climbingStatsControllerGetUserStatsCallback
     * @param {String} error Error message, if any.
