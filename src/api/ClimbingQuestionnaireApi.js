...
* @version 1.0
*/
export default class ClimbingQuestionnaireApi {
    ...
    */
     ...
     * @callback module:api/ClimbingQuestionnaireApi~climbingQuestionnaireControllerFindAllCallback
     ...
     * data is of type: {@link Array.<module:model/ClimbingQuestionnaire>}
     */
     ...
     * @callback module:api/ClimbingQuestionnaireApi~climbingQuestionnaireControllerFindForUserCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ClimbingQuestionnaire>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @callback module:api/ClimbingQuestionnaireApi~climbingQuestionnaireControllerFindOneCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link module:model/ClimbingQuestionnaire}
     */
     ...
     * @callback module:api/ClimbingQuestionnaireApi~climbingQuestionnaireControllerGetAnalysisMessageCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:api/ClimbingQuestionnaireApi~climbingQuestionnaireControllerSaveUserQuestionnaireCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
